    ...
    public class ProductManager
    {
        ...
        public static List<Models.Product> GetAllProducts()
        {
            if (Products == null || !Products.Any())
            {
                ...
                Products.Add(new Models.CandyBag(7, "Frukttoppar", "Dragerat skumgodis med smak av jordgubbe, päron och persika/aprikos.", false, 15.90, "https://candypeople.se/wp-content/uploads/2017/10/113300_Frukttoppar_140g_utan_logga-300x232.jpg", 100, 140));
